...
export class show_model{
	constructor(option={}) {
		...
		let confirmColor=option.confirmColor||'#57BC4C';
	...
	creatView(style,opa,clickEvent,modelInfo){
		...
		view.draw([
		    ...
		    {tag:'rect',id:'concent',color:`rgb(255,255,255)`,rectStyles:{borderWidth:'2px',radius:'8px'},position:{top:'42%',left:'15%',width:'70%',height:'16%'}},
		    {tag:'font',id:'title',text:modelInfo.tit,textStyles:{size:'18px',color:'#000'},position:{top:this.pageHeight*0.435+'px',left:'15%',width:'70%',height:'2%'}},
		    {tag:'font',id:'text',text:modelInfo.concent,textStyles:{size:'16px',color:'#666',whiteSpace:'normal',align:modelInfo.align},position:{top:this.pageHeight*0.455+'px',left:'23%',width:'54%',height:'8%'}},
		    {tag:'rect',id:'line',color:'#EAEAEC',position:{top:'53%',left:'15%',width:'70%',height:'1px'}},
		...
		if(!modelInfo.delCancel){
			// 取消	
			let viewCancel=new plus.nativeObj.View('cancel',{width:'35%',height:'5%',top:this.pageHeight*0.53+'px',left:'15%',backgroundColor:'rgba(255,255,255,0)'});
			    viewCancel.draw([
		...
		// 确认
		let viewconfirm=new plus.nativeObj.View('confirm',{width:modelInfo.delCancel?'70%':'35%',height:'5%',top:this.pageHeight*0.53+'px',left:modelInfo.delCancel?'15%':'50%',backgroundColor:'rgba(255,255,255,0)'});
	        viewconfirm.draw([
